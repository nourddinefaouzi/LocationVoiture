...
<body>
    ...
    <div class="main-content">
        ...
        <button class="create-btn"><a class="ajout-btn" href={{route('clients.create')}}>Ajouter un client</a></button>
        <table>
            <thead>
                <tr>
                    <th>name</th>
                ...
                @foreach($users as $user)
                    @if($user->client)
                        <tr>
                            ...
                            <td>{{ $user->client->Permis }}</td>
                            <td>{{ $user->client->Adresse }}</td>
                            <td>{{ $user->client->cin }}</td>
                            <td>{{ $user->client->passport }}</td>
                            <td class="actions">
                                <a href={{ route('clients.show', $user->id) }}>👁️</a>
                            </td>
                            <td class="actions">
                                <button class="btn-update"><a href={{route('clients.edit', $user->id)}}>✏️</a></button>
                            </td>
                            <td class="actions">
