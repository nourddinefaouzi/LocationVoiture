    ...
    <div class="main-content">
        ...
        <div class="reservation-details">
            <div class="reservation-header">
                <div class="reservation-id">Client {{$user->id}}</div>
            ...
            <div class="detail-group">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{$user->client->Tel}}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Permis:</span>
                    <span class="detail-value">{{$user->client->Permis}}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Adresse:</span>
                    <span class="detail-value">{{$user->client->Adresse}}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">CIN:</span>
                    <span class="detail-value">{{$user->client->cin}}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Passport:</span>
                    <span class="detail-value">{{$user->client->passport}}</span>
                </div>
            </div>
        
            <div class="actions">
                <button class="action-btn edit-btn"><a href={{route('clients.edit', $user->id)}}>Edit Client</a></button>
                <form action={{route('clients.destroy', $user->id)}} method="POST">
                    @csrf
                    @method('DELETE')
                    <button class="action-btn delete-btn" type="submit">Delete Client</button>
                </form>
            </div>
        </div>
    </div>
